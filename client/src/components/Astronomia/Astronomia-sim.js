...
import sim_n3 from '../docs/simulados-astronomia/Simulado_OBA_Astronomia_N3___OB_2025.pdf';
import sim_n4 from '../docs/simulados-astronomia/Simulado_OBA_Astronomia_N4___OB_2025dois.pdf';
            ...
            <div class="fundo">
                <center>
                    <div className="text-container3">
                        <h4 className="fontezao7cor">Simulado OBA (N3)</h4>
                    </div>
                    <div class="text-container5">
                        <a class="active" href={sim_n3}>
                            <h4 className="cordiff">Questões | Gabarito</h4>
                        </a>
                    </div>
                    <br />
                    <div className="text-container3">
                        <h4 className="fontezao7cor">Simulado OBA (N4)</h4>
                    </div>
                    <div class="text-container5">
                        <a class="active" href={sim_n4}>
                            <h4 className="cordiff">Questões | Gabarito</h4>
                        </a>
                    </div>
                    <br />
